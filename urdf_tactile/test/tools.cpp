...
BOOST_AUTO_TEST_CASE(test_array_iterator_rowmajor) {test_array_iterator(TactileArray::ROWMAJOR);}
BOOST_AUTO_TEST_CASE(test_array_iterator_colmajor) {test_array_iterator(TactileArray::ROWMAJOR);}
