...
BOOST_AUTO_TEST_CASE(test_array_iterator)
{
  ...
  auto it = TaxelArrayIterator::begin(sensor);
  auto end = TaxelArrayIterator::end(sensor);
...
BOOST_AUTO_TEST_CASE(test_vector_iterator)
{
  ...
  auto it = TaxelVectorIterator::begin(sensor);
  auto end = TaxelVectorIterator::end(sensor);
